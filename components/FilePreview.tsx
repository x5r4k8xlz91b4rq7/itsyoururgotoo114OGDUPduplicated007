...
import FilePreviewModal, { PreviewItem } from './FilePreviewModal';
...
const FilePreview: React.FC<FilePreviewProps> = ({
  ...
  return (
    <>
      ...
      {isPreviewOpen && activeFileId === file.id && onClosePreview && (
        <FilePreviewModal
          ...
          onDelete={onRemove ? (id: string) => onRemove(id) : undefined}
          onReorder={onReorder}
